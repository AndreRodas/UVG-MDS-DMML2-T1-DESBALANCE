...
if __name__ == '__main__':
    ...
    imputar_datos = True
    normalizar_datos = False    #Ya se le aplico un PCA
    ...
    # Leemos los archivos
    print("\nLeyendo archivos...")
    #C:\Users\ajrodas\Documents\GitHub\UVG-MDS-DMML2-CLASDESB
    train = pd.read_csv("C:/Users/ajrodas/Documents/GitHub/UVG-MDS-DMML2-CLASDESB/ejemplo/train.csv")
    validation = pd.read_csv("C:/Users/ajrodas/Documents/GitHub/UVG-MDS-DMML2-CLASDESB/ejemplo/validation.csv")
    test = pd.read_csv("C:/Users/ajrodas/Documents/GitHub/UVG-MDS-DMML2-CLASDESB/ejemplo/test.csv")
